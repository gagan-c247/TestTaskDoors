...
class UserRegistrationRequest extends FormRequest{
    ...
    public function rules(){
        return [
            ...
            // 'company_phone'               => 'required|digits_between:9,20',
            'company_phone'               => 'required',
            // 'company_reg_doc'             => 'required|mimes:doc,pdf,docx,zip,jpeg,bmp,png,gif,svg,jpg',
            ...
            // 'phone_nu'    => 'required|digits_between:9,20',
            'phone_nu'    => 'required',
        ];
    }
    ...
    public function messages(){
        return [
            ...
            // 'company_reg_doc.required'             => 'Company registration document field is required.',
            'company_nu_molding_machines.required' => 'No. of company modeling machine field is required.',
            'company_nu_molding_machines.numeric'  => 'No. of company modeling machine must be a number.',
            'companey_nu_sites.required'           => 'No. of company sites field is required.',
            'companey_nu_sites.numeric'            => 'No. of company sites must be a number.',
            /* ========== ADDRESS ========== */
